...
欢迎！这是为前端初学者准备的 React 架构深度学习资料。本指南包含三个主要文档，帮助你从零开始，逐步深入理解 React 的架构和原理。

## 📚 文档列表

### 1. [React 架构深度解析（前端初学者指南）](./REACT_ARCHITECTURE_CN.md)
**推荐阅读顺序：第一篇**

这是主要的架构文档，详细介绍了 React 的核心概念和整体架构。
...
### 2. [React 架构图解](./ARCHITECTURE_DIAGRAMS.md)
**推荐阅读顺序：第二篇**
...
### 3. [React 实战示例集合](./PRACTICAL_EXAMPLES.md)
**推荐阅读顺序：第三篇**
